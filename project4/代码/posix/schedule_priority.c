...
void schedule()
{
    ...
    printf("Average turnaround time of the Priority Scheduling is %.3lf\n",(double)total_trunaround_time/(double)number_of_tasks);
    printf("Average waiting time of the Priority Scheduling is %.3lf\n",(double)total_waiting_time/(double)number_of_tasks);
    printf("Average response time of the Priority Scheduling is %.3lf\n",(double)total_response_time/(double)number_of_tasks);
